...
public class f_clientes extends JFrame {
	...
	private void initialize() {
		...
		this.setIconImage(Toolkit.getDefaultToolkit().getImage("IMAGENES/GENTE.JPG"));
	...
	private void guardar(){
	    ...
	    {String fechasql=new String(txtFecha.getText().substring(6)+"-"+txtFecha.getText().substring(3,5)+"-"+txtFecha.getText().substring(0,2));
		 sentencia=conexion.createStatement();
		 if (nuevoreg==true)
		 	{sentencia.executeUpdate("INSERT INTO CLIENTES (ID_CLI,NOM_CLI,APE_CLI,DIR_CLI,CER_CLI,TEL_CLI,CEL_CLI,SEX_CLI,FEC_ING,EMA_CLI,SAL_CLI) VALUES('"+txtCodigo.getText()+
		    ...
		    {sentencia.executeUpdate("UPDATE CLIENTES SET NOM_CLI='"+txtNombre.getText()+"',APE_CLI='"+txtApellido.getText()+"',DIR_CLI='"+txtDireccion.getText()+
